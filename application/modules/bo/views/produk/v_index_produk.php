                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                        	<?php if ($this->m_master->group_akses() == false){?>
                             ...
                             <a class="btn btn-primary btn-sm" href="<?php echo base_url('bo/'.$class.'/export_pdt/csv/1')?>">Export CSV to PDT</a>
                             <span class="pull-right">                             
	                             <a class="btn btn-primary btn-sm" href="<?php echo base_url('bo/'.$class.'/export/csv/1')?>">Export CSV</a>
	                             <a class="btn btn-info btn-sm" href="<?php echo base_url('bo/'.$class.'/export/excel/1')?>">Export Excel</a>
	                             <a class="btn btn-warning btn-sm" href="<?php echo base_url('bo/'.$class.'/export/pdf/1')?>" target="_blank">Export PDF</a>                        
                             </span>
                        </div>
